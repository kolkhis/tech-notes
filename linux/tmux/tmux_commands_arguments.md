...
### Raw Output of `tmux list-commands`
...
tmux set-window-option (setw) [-aFgoqu] [-t target-window] option [value]  
...
tmux show-window-options (showw) [-gv] [-t target-window] [option]  
